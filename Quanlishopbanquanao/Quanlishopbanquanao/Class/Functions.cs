...
namespace Quanlishopbanquanao.Class
{
    class Functions
    {
        ...
        public static void Connect()
        {
            ...
            Con.ConnectionString = @"Data Source=DESKTOP-8KS3GHD\SQLEXPRESS;Initial Catalog=Quanlybanhang;User ID=sa; Password = 123";
            Con.Open();                  //Mở kết nối
                                         //Kiểm tra kết nối
            if (Con.State == ConnectionState.Open)
                MessageBox.Show("Chào mừng đến với phần mềm quản lý bán hàng quần áo 208 , bạn cần đăng nhập trước khi dùng phần mềm!");
